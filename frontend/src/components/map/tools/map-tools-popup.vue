...
<template>
    <div v-click-outside="close" class="map-tools-popup">
        <div class="map-tools-popup__section">
            <signaling-system-picker :view="view" />
        </div>
        <!--        <div-->
        ...
        <div class="map-tools-popup__section">
            <div @click="exportFrames()" class="map-tools-popup__button">
                <div class="map-tools-popup__title">Export frames</div>
            </div>
        </div>
    </div>
</template>
