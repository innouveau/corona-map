...
<template>
    <div v-if="frames.length > 0" class="population-test-numbers">
        ...
        <div class="population-test-numbers__table">
            <div class="population-test-numbers__head">
                <div class="population-test-numbers__row">
                    ...
                    <div
                        class="population-test-numbers__cell population-test-numbers__frame-positive"
                    >
                        Positive
                    </div>
                    <div
                        class="population-test-numbers__cell population-test-numbers__frame-total"
                    >
                        Total tests
                    </div>
                    <div
                        class="population-test-numbers__cell population-test-numbers__frame-percentage"
                    >
                        % pos
                    </div>
                </div>
            ...
            <div v-for="frame in frames" class="population-test-numbers__row">
                ...
                >
                    {{
                        (
                            (100 * frame.positiveAntigenTests) /
