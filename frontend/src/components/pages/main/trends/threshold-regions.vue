    ...
    methods: {
        getRegions(threshold) {
            ...
            const getTotalRelativeIncreaseWeek = (region) => {
                return region.getTotalIncreaseOfType(
                    this.view.offset,
                    7,
                    "positiveTests",
                    true
            ...
            return regions
                ...
                .sort((a, b) =>
                    getTotalRelativeIncreaseWeek(a) <
                    getTotalRelativeIncreaseWeek(b)
                        ? 1
                        : getTotalRelativeIncreaseWeek(b) <
                          getTotalRelativeIncreaseWeek(a)
                        ? -1
...
<template>
    <div class="section threshold-regions">
        ...
        <div class="section__body">
            <div v-for="threshold in thresholds" class="threshold-regions__row">
